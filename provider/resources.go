...
import (
	...
	george "github.com/iwahbe/terraform-provider-george/provider"

	"github.com/pulumi/pulumi-george/provider/pkg/version"
)
...
const (
	...
	mainPkg = "george"
	// modules:
	mainMod = "index" // the george module
)

//go:embed cmd/pulumi-resource-george/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-george/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-george/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "george", george.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-george/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(george.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing george cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"GERey", "george", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pulumi/pulumi-george",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/pulumi/pulumi-george/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("george_", mainMod,
